...
namespace ChannelSvcs
{
  ...
  //
  void ChannelLoadSessionImpl::check(
  ...
  //
  void ChannelLoadSessionImpl::update_triggers(
  ...
  void ChannelLoadSessionImpl::update_all_ccg(
