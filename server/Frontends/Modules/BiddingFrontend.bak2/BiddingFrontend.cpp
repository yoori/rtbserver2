...
namespace Bidding
{
  namespace
  {
    ...
    struct GetId
    {
      ...
      unsigned int
      operator() (const ObjectType& obj) const noexcept
      {
        return obj.id;
      }
    };
  ...
  protected:
    virtual ~GoogleRequestTask() noexcept {}
  ...
  public:
        ...
        uri(request.uri().str())
    {
      ...
      if(apply_unzip)
      {
        ...
        zs.avail_in = bid_request_.size();
        zs.next_in = (Bytef*)&bid_request_[0];
        ...
        {
          // decompression error
          throw RequestTask::Invalid("can make unzip");
        }
  ...
  protected:
    virtual ~OpenRtbRequestTask() noexcept {}
  ...
  protected:
    virtual ~AppNexusRequestTask() noexcept {}
    ...
    noexcept
  {
    ...
    try
    {
        ...
        config_->GoogleUriList().Uri(), request.uri(), found_uri))
      {
        ...
        catch(const RequestTask::Invalid& e)
        {
          Stream::Error ostr;
