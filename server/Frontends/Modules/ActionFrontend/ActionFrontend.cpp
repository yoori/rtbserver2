...
namespace Action
{
    ...
    /*throw (Exception, eh::Exception)*/
  {
    ...
    /*
    std::cerr << "request_info.user_id = " << request_info.user_id.to_string() << std::endl;
    std::cerr << "request_info.utm_resolved_user_id = " << request_info.utm_resolved_user_id.to_string() << std::endl;
    std::cerr << "request_info.utm_cookie_user_id = " << request_info.utm_cookie_user_id.to_string() << std::endl;
    std::cerr << "utm_cookie_resolved_user_id = " << utm_cookie_resolved_user_id.to_string() << std::endl;
    */
