...
namespace CampaignSvcs
{
  ...
  CampaignServerImpl_v340::get_config(
    ...
    throw(AdServer::CampaignSvcs_v340::CampaignServer::ImplementationException,
      AdServer::CampaignSvcs_v340::CampaignServer::NotReady)
  {
  ...
  CampaignServerImpl_v340::get_colocation_flags()
    throw (
      AdServer::CampaignSvcs_v340::CampaignServer::ImplementationException,
      AdServer::CampaignSvcs_v340::CampaignServer::NotReady)
  {
    try
    {
  ...
  CampaignServerImpl_v340::get_stat() throw(
    AdServer::CampaignSvcs_v340::CampaignServer::NotSupport,
    AdServer::CampaignSvcs_v340::CampaignServer::NotReady)
  {
  ...
  void
  CampaignServerImpl_v340::update_stat() throw(
    AdServer::CampaignSvcs_v340::CampaignServer::NotSupport,
    AdServer::CampaignSvcs_v340::CampaignServer::ImplementationException)
  {
    throw AdServer::CampaignSvcs_v340::CampaignServer::NotSupport(
